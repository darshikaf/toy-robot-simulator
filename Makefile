...
TERM := docker run --rm -it -v $(shell pwd):/robot_simulator -w /robot_simulator darshika/${DOCKER_IMAGE}
TESTENV	:= docker run --rm -v $(shell pwd):/robot_simulator -w /robot_simulator darshika/${DOCKER_IMAGE}
